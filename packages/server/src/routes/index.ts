...
// RAV-811 v2 negative CI proof only: this intentionally lacks an execution fence.
router.post('/runtime/unfenced-proof-v2', (_req: Request, res: Response) => res.json({ ok: true }));
