...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'data_1000', name: 'Kilobyte Club', description: 'Deposit 100 kB data', category: 'resources', secret: false,
    check: () => getStat('total_data_deposited') >= 100_000,
    progress: () => ({ current: getStat('total_data_deposited'), target: 100_000 }) },
  { id: 'data_10000', name: 'Megabyte Mogul', description: 'Deposit 1 MB data', category: 'resources', secret: false,
