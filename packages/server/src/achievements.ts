...
export const ACHIEVEMENTS: AchievementDef[] = [
  // Resources
  { id: 'first_ore', name: 'First Ore', description: 'Deposit your first ore', category: 'resources', secret: false,
    check: () => getStat('total_ore_deposited') >= 1 },
  { id: 'ore_100', name: 'Ore Hoarder', description: 'Deposit 100 ore', category: 'resources', secret: false,
    check: () => getStat('total_ore_deposited') >= 100,
    progress: () => ({ current: getStat('total_ore_deposited'), target: 100 }) },
  { id: 'ore_1000', name: 'Ore Baron', description: 'Deposit 1,000 ore', category: 'resources', secret: false,
    check: () => getStat('total_ore_deposited') >= 1000,
    progress: () => ({ current: getStat('total_ore_deposited'), target: 1000 }) },
  { id: 'first_energy', name: 'Power On', description: 'Deposit your first energy', category: 'resources', secret: false,
    check: () => getStat('total_energy_deposited') >= 1 },
  { id: 'energy_500', name: 'Power Surge', description: 'Deposit 500 energy', category: 'resources', secret: false,
    check: () => getStat('total_energy_deposited') >= 500,
    progress: () => ({ current: getStat('total_energy_deposited'), target: 500 }) },
  { id: 'first_data', name: 'Data Stream', description: 'Deposit your first data', category: 'resources', secret: false,
    check: () => getStat('total_data_deposited') >= 1 },
  { id: 'data_500', name: 'Data Architect', description: 'Deposit 500 data', category: 'resources', secret: false,
    check: () => getStat('total_data_deposited') >= 500,
    progress: () => ({ current: getStat('total_data_deposited'), target: 500 }) },
