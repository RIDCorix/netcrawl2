...
export const ACHIEVEMENTS: AchievementDef[] = [
  // Resources
  {
    id: 'first_data',
    name: 'First Byte',
    description: 'Deposit your first data',
    category: 'resources',
    secret: false,
  ...
  },
  {
    id: 'data_1000',
    name: 'Kilobyte Club',
    description: 'Deposit 100 kB data',
    category: 'resources',
    secret: false,
    check: () => getStat('total_data_deposited') >= 100_000,
    progress: () => ({ current: getStat('total_data_deposited'), target: 100_000 }),
  },
  {
    id: 'data_10000',
    name: 'Megabyte Mogul',
    ...
    category: 'resources',
    secret: false,
    check: () => getStat('total_data_deposited') >= 1_000_000,
    progress: () => ({ current: getStat('total_data_deposited'), target: 1_000_000 }),
  },
  {
    id: 'first_rp',
    name: 'Eureka',
    description: 'Earn your first Research Point',
    category: 'resources',
    secret: false,
  ...
  },
  {
    id: 'rp_50',
    name: 'Researcher',
    description: 'Earn 50 Research Points',
    category: 'resources',
    secret: false,
  ...
  // Workers
  {
    id: 'first_deploy',
    name: 'Hello World',
    description: 'Deploy your first worker',
    category: 'workers',
    secret: false,
  ...
  },
  {
    id: 'first_repair',
    name: 'Virus Purge',
    description: 'Repair an infected node',
    category: 'workers',
    secret: false,
  ...
  },
  {
    id: 'craft_all',
    name: 'Master Crafter',
    description: 'Craft every recipe at least once',
    category: 'crafting',
    secret: true,
  ...
  },
  {
    id: 'max_upgrade',
    name: 'Overclocked',
    description: 'Max out a node upgrade',
    category: 'nodes',
    secret: false,
  ...
  },
  {
    id: 'packs_10',
    name: 'Pack Rat',
    description: 'Open 10 chip packs',
    category: 'chips',
    secret: false,
  ...
  },
  {
    id: 'first_rare',
    name: 'Blue Gleam',
    description: 'Obtain a rare chip',
    category: 'chips',
    secret: false,
  ...
  },
  {
    id: 'first_legendary',
    name: 'Jackpot',
    description: 'Obtain a legendary chip',
    category: 'chips',
    secret: false,
  ...
  },
  {
    id: 'first_install',
    name: 'Socketed',
    description: 'Install a chip into a node',
    category: 'chips',
    secret: false,
  ...
  // Puzzles
  {
    id: 'first_solve',
    name: 'Hello, Compute!',
    description: 'Solve your first compute puzzle',
    category: 'crafting',
    secret: false,
  ...
  },
  {
    id: 'solve_10',
    name: 'Problem Solver',
    description: 'Solve 10 compute puzzles',
    category: 'crafting',
    secret: false,
  ...
  },
  {
    ...
    description: 'Solve 50 compute puzzles',
    category: 'crafting',
    secret: false,
  ...
  // Secret
  {
    ...
    description: 'Lose the game — the Hub was your only lifeline',
    category: 'secret',
    secret: true,
  ...
  },
  {
    id: 'speedrun',
    name: 'Speed Run',
    description: 'Reach 100 total deposits before tick 500',
    category: 'secret',
    secret: true,
