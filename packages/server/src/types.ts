...
export interface NodeData {
  ...
  drops?: Item[];
  mineCount?: number;
  /** Available resource supply for this mine. Consumed by mine(), regenerated by game ticks. */
  data?: number;
  /** Maximum resource supply for this mine. This is separate from the floor-item buffer. */
