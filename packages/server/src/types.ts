...
const R = (label: string, rate: number, cost: Record<string, number>, badDataChance: number = 0.2) => ({
  ...
  enhancementPoints: 0,
  statAlloc: {} as Record<string, number>,
  baseDefense: 0,
  bad_data_chance: badDataChance,
});
...
export const INITIAL_NODES = [
  ...
  // NORTH — Mining District
  {
    ...
    type: 'resource',
    position: { x: 0, y: -300 },
    data: { ...R('Data Mine Nano', 30, { data: 2000 }, 0.4), unlocked: true },
  },
  {
    id: 'n_mine1',
    type: 'resource',
    position: { x: -220, y: -500 },
    data: R('Data Mine Alpha', 50, { data: 10000 }, 0.25),
  },
  {
    id: 'n_mine2',
    type: 'resource',
    position: { x: 220, y: -500 },
    data: R('Data Mine Beta', 40, { data: 15000 }, 0.2),
  },
  ...
  { id: 'n_empty1', type: 'empty', position: { x: 0, y: -1100 }, data: E('Open Slot', { data: 80000, rp: 3 }) },
  {
    ...
    type: 'resource',
    position: { x: 0, y: -1300 },
    data: R('Deep Core Alpha', 100, { data: 200000, rp: 5 }),
  },
  {
    id: 'n_deep2',
    type: 'resource',
    position: { x: -350, y: -1100 },
    data: R('Deep Core Beta', 80, { data: 150000, rp: 3 }),
  },
  ...
  { id: 'ne_relay2', type: 'empty', position: { x: 780, y: -280 }, data: Y('Relay NE2', { data: 60000 }) },
  {
    ...
    data: C('Compute C2', 'medium', { data: 100000, rp: 5 }),
  },
  {
    id: 'ne_comp3',
    type: 'compute',
    position: { x: 980, y: -130 },
    data: C('Compute C3', 'medium', { data: 120000, rp: 8 }),
  },
  { id: 'ne_empty1', type: 'empty', position: { x: 780, y: -500 }, data: E('Open Slot', { data: 150000, rp: 5 }) },
  {
    ...
    data: C('Compute C4', 'hard', { data: 300000, rp: 15 }),
  },
  ...
  { id: 'e_relay1', type: 'empty', position: { x: 420, y: 100 }, data: Y('Relay E1', { data: 18000 }) },
  {
    ...
    data: { ...C('Data Types', 'easy', { data: 15000 }), fixedPuzzleTemplate: 'typeof' },
  },
  {
    id: 'e_op_add',
    type: 'compute',
    position: { x: 880, y: -120 },
    data: { ...C('Operator <+>', 'easy', { data: 20000 }), fixedPuzzleTemplate: 'add' },
  },
  {
    id: 'e_op_sub',
    type: 'compute',
    position: { x: 880, y: -10 },
    data: { ...C('Operator <->', 'easy', { data: 20000 }), fixedPuzzleTemplate: 'subtract' },
  },
  {
    id: 'e_op_mul',
    type: 'compute',
    position: { x: 880, y: 100 },
    data: { ...C('Operator <*>', 'easy', { data: 25000 }), fixedPuzzleTemplate: 'multiply' },
  },
  {
    id: 'e_op_div',
    type: 'compute',
    position: { x: 880, y: 210 },
    data: { ...C('Operator <//>', 'easy', { data: 25000 }), fixedPuzzleTemplate: 'floor_div' },
  },
  {
    id: 'e_op_mod',
    type: 'compute',
    position: { x: 880, y: 320 },
    data: { ...C('Operator <%>', 'easy', { data: 30000 }), fixedPuzzleTemplate: 'modulo' },
  },
  {
    id: 'e_calc',
    type: 'compute',
    position: { x: 1140, y: 100 },
    data: { ...C('Calculator', 'hard', { data: 50000, rp: 3 }), fixedPuzzleTemplate: 'calculator' },
  },
  ...
  { id: 'se_empty1', type: 'empty', position: { x: 680, y: 860 }, data: E('Open Slot', { data: 250000, rp: 10 }) },
  {
    ...
    data: Y('Encrypted Vault', { data: 500000, rp: 20 }),
  },
  ...
  { id: 's_relay1', type: 'empty', position: { x: 0, y: 380 }, data: Y('Relay S1', { data: 8000 }) },
  {
    ...
    data: C('Compute Alpha', 'easy', { data: 40000 }),
  },
  ...
  { id: 'sw_mine1', type: 'resource', position: { x: -560, y: 200 }, data: R('Data Mine Mike', 45, { data: 40000 }) },
  {
    ...
    data: R('Data Mine November', 55, { data: 60000 }),
  },
  { id: 'sw_relay2', type: 'empty', position: { x: -560, y: 680 }, data: Y('Relay SW2', { data: 90000 }) },
  {
    ...
    data: C('Compute C6', 'medium', { data: 120000, rp: 5 }),
  },
  { id: 'sw_empty1', type: 'empty', position: { x: -780, y: 200 }, data: E('Open Slot', { data: 180000, rp: 7 }) },
  {
    ...
    type: 'locked',
    position: { x: -780, y: 60 },
    data: Y('Quarantine Zone', { data: 400000, rp: 15 }),
  },
  ...
  { id: 'nw_relay1', type: 'empty', position: { x: -320, y: -280 }, data: Y('Relay NW1', { data: 20000 }) },
  {
    ...
    data: R('Data Mine Quebec', 45, { data: 50000 }),
  },
  {
    id: 'nw_comp1',
    type: 'compute',
    position: { x: -400, y: -520 },
    data: C('Research Lab', 'hard', { data: 200000, rp: 10 }),
  },
  { id: 'nw_relay2', type: 'empty', position: { x: -600, y: -680 }, data: Y('Relay NW2', { data: 150000 }) },
  {
    ...
    data: C('Deep Research Lab', 'hard', { data: 400000, rp: 20 }),
  },
  { id: 'nw_empty1', type: 'empty', position: { x: -600, y: -880 }, data: E('Open Slot', { data: 300000, rp: 15 }) },
  {
    ...
    data: { ...C('Observatory', 'hard', { data: 800000, rp: 30 }), unlocked: true, fixedPuzzleTemplate: 'calculator' },
  },
