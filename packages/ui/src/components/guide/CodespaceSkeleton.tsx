  ...
  return (
    <div className="codespace-skeleton-ide">
      <div className="codespace-skeleton-activity">
        <span className="codespace-skeleton-activity-active">▤</span><span>⌕</span><span>⑂</span><span>◫</span>
      </div>
      <aside className="codespace-skeleton-sidebar">
        <div className="codespace-skeleton-sidebar-title">EXPLORER <span>···</span></div>
      ...
      <div className="codespace-skeleton-workbench">
        <div className="codespace-skeleton-tabs"><span className="codespace-skeleton-tab-active">▣ main.py</span><span>×</span><span className="codespace-skeleton-tab-muted">README.md</span></div>
        ...
        <div className="codespace-skeleton-panel">
          <div className="codespace-skeleton-panel-tabs"><span className="codespace-skeleton-panel-tab-active">TERMINAL</span><span>PROBLEMS</span><span>OUTPUT</span><span>DEBUG CONSOLE</span><span className="codespace-skeleton-panel-close">×</span></div>
          <div className={`codespace-skeleton-terminal ${highlightTerminal ? 'codespace-skeleton-highlight' : ''}`}><span className="codespace-skeleton-terminal-path">~/netcrawl-workspace</span><span><b>$</b> {terminalText}</span><span className="codespace-skeleton-terminal-caret">▌</span></div>
        </div>
      </div>
      <div className="codespace-skeleton-statusbar"><span>⎇ main</span><span>Python 3.12</span><span>✓ 0 errors</span><span>◉ Codespaces</span></div>
    </div>
  );
}
...
function CodespaceCreation() {
  return (
    <div className="codespace-skeleton-github">
      <div className="codespace-skeleton-github-nav"><span className="codespace-skeleton-github-mark">●</span><span>GitHub</span><span>Product</span><span>Solutions</span><span>Resources</span><span>Open Source</span><span className="codespace-skeleton-search">⌕  Search or jump to...</span><span>Sign in</span></div>
      <div className="codespace-skeleton-breadcrumb">GitHub / Codespaces / <b>New codespace</b></div>
      <div className="codespace-skeleton-create-body"><div className="codespace-skeleton-create-title">Create a codespace</div><div className="codespace-skeleton-create-subtitle">Create a development environment for your repository.</div><div className="codespace-skeleton-create-card"><div className="codespace-skeleton-create-card-title">Repository</div><div className="codespace-skeleton-repo-select">Starscribers / netcrawl-workspace <span>⌄</span></div><div className="codespace-skeleton-create-card-title">Branch</div><div className="codespace-skeleton-repo-select">main <span>⌄</span></div><div className="codespace-skeleton-create-card-title">Machine type</div><div className="codespace-skeleton-repo-select">2-core <span>⌄</span></div><div className="codespace-skeleton-actions"><button type="button" className="codespace-skeleton-button">Resume</button><button type="button" className="codespace-skeleton-button codespace-skeleton-highlight">Create codespace</button></div></div></div>
    </div>
  );
}
