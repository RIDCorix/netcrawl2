...
export function InfectedNode({ id, data, selected }: any) {
  return (
    <NodeWrapper selected={selected} glowColor="var(--danger)" nodeId={id} showWorkerDots={data.showWorkerDots} edgeStyle={data.edgeStyle} fadeIn={data.fadeIn} routeIndices={data.routeIndices} unlockable={data.unlockable} unlocked={data.unlocked} style={{
...
export function LockedNode({ id, data, selected }: any) {
  return (
    <NodeWrapper selected={selected} nodeId={id} showWorkerDots={data.showWorkerDots} edgeStyle={data.edgeStyle} fadeIn={data.fadeIn} routeIndices={data.routeIndices} unlockable={data.unlockable} unlocked={data.unlocked} style={{
      opacity: 0.4,
...
export function CacheNode({ id, data, selected }: any) {
  return (
    <NodeWrapper selected={selected} glowColor={data.unlocked ? '#a78bfa' : undefined} nodeId={id} showWorkerDots={data.showWorkerDots} edgeStyle={data.edgeStyle} fadeIn={data.fadeIn} routeIndices={data.routeIndices} unlockable={data.unlockable} unlocked={data.unlocked} style={{ opacity: data.unlocked ? 1 : 0.5 }}>
...
export function AuthNodeComponent({ id, data, selected }: any) {
  ...
  return (
    <NodeWrapper selected={selected} glowColor="#a78bfa" nodeId={id} showWorkerDots={data.showWorkerDots} edgeStyle={data.edgeStyle} fadeIn={data.fadeIn} routeIndices={data.routeIndices} unlockable={data.unlockable} unlocked={data.unlocked} style={{ opacity: unlocked ? 1 : 0.5 }}>
...
export function APINodeComponent({ id, data, selected }: any) {
  ...
  return (
    <NodeWrapper selected={selected} glowColor={slaColor} nodeId={id} showWorkerDots={data.showWorkerDots} edgeStyle={data.edgeStyle} fadeIn={data.fadeIn} routeIndices={data.routeIndices} unlockable={data.unlockable} unlocked={data.unlocked} style={{ opacity: unlocked ? 1 : 0.5 }}>
      <RFHandle type="target" position={RFPosition.Left} style={{ opacity: 0 }} />
      <RFHandle type="source" position={RFPosition.Right} style={{ opacity: 0 }} />
      <RFHandle type="target" position={RFPosition.Top} style={{ opacity: 0 }} />
      <RFHandle type="source" position={RFPosition.Bottom} style={{ opacity: 0 }} />
