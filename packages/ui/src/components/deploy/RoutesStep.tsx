          ...
          >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  <span
                    style={{
                      ...
                      padding: '1px 6px',
                      borderRadius: 4,
                      background: isEdge ? 'rgba(96,165,250,0.15)' : 'rgba(167,139,250,0.15)',
                      color: isEdge ? '#60a5fa' : '#a78bfa',
                      fontFamily: 'var(--font-mono)',
                      fontWeight: 600,
                    }}
                  >
            ...
            {filled && (
              ...
              >
                {isEdge ? (
                  <span>
                    <span style={{ fontWeight: 700 }}>{getNodeLabel(edges[0].source)}</span>{' '}
                    <span style={{ color: 'var(--text-muted)' }}>↔</span>{' '}
                    <span style={{ fontWeight: 700 }}>{getNodeLabel(edges[0].target)}</span>
                  </span>
                ) : (
