    ...
    >
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div
                style={{ fontSize: 9, fontWeight: 700, color, fontFamily: 'var(--font-mono)', letterSpacing: '0.1em' }}
              >
        ...
        >
          ...
          {msg && !claimed && (
            <span style={{ fontSize: 9, color: 'var(--danger)', fontFamily: 'var(--font-mono)' }}>{msg}</span>
          )}
          {quest.manualEntryId && (
            <button
              onClick={() => {
            ...
            >
              <BookOpen size={10} /> {t('ui.open_manual')}
            </button>
          )}
        </div>
