  ...
  return (
    ...
    >
      ...
      <ResourceItem
        ...
        tooltip={t('res.data.desc')}
      />
      <ResourceItem
        icon={Cpu}
        value={resources.rp}
        label={t('ui.research_points')}
        color="var(--rp-color)"
        prevValue={prev.rp}
        tooltip={t('res.rp.desc')}
      />
      <ResourceItem
        icon={Star}
        ...
        prevValue={prev.credits}
        tooltip={t('res.credits.desc')}
      />
      ...
      >
        ...
        {codeServerUp ? window.location.port && <span>:{window.location.port}</span> : <span>Connect</span>}
      </motion.button>
