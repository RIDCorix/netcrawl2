...
export const ITEM_ICONS: Record<string, any> = {
  pickaxe_basic: PickaxeBasic,
  pickaxe_iron: PickaxeIron,
  pickaxe_diamond: PickaxeDiamond,
  shield: ShieldIcon,
  beacon: BeaconIcon,
  data_fragment: Database,
  rp_shard: Cpu,
  bad_data: AlertTriangle,
  chip_pack_basic: ChipPackBasic,
  chip_pack_premium: ChipPackPremium,
  cpu_basic: CpuBasic,
  cpu_advanced: CpuAdvanced,
  ram_basic: RamBasic,
  ram_advanced: RamAdvanced,
  scanner: ScannerIcon,
  signal_booster: BeaconIcon,
  overclock_kit: ChipSpeed,
  antivirus_module: AntivirusIcon,
  memory_allocator: MemoryAllocator,
  fullstack_pickaxe: FullstackPickaxe,
};
...
export const INV_TABS_DEF = [
  ...
  {
    key: 'equipment',
    labelKey: 'ui.tab_equipment',
    types: ['pickaxe_basic', 'pickaxe_iron', 'pickaxe_diamond', 'shield', 'beacon'],
  },
...
export const CRAFT_TABS_DEF = [
  ...
  {
    key: 'gear',
    labelKey: 'ui.tab_gear',
    ids: ['shield', 'beacon', 'cpu_basic', 'cpu_advanced', 'ram_basic', 'ram_advanced'],
  },
...
export const CRAFT_FAMILIES: CraftFamily[] = [
  {
    ...
    icon: PickaxeBasic,
    color: '#c0c0c0',
    recipeIds: ['pickaxe_basic', 'pickaxe_iron', 'pickaxe_diamond'],
  },
