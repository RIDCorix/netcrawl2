      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {packs.map(p => (
            ...
            >
              <div
                style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'var(--font-mono)' }}
              >
                {t('item.' + p.packType + '.name') || p.name}
              </div>
              <div style={{ fontSize: 9, color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>
                {t('item.' + p.packType + '.desc') || p.description}
              </div>
                ...
                {Object.entries(p.cost).map(([k, v]) => (
                  <span
                    ...
                    style={{
                      ...
                      fontFamily: 'var(--font-mono)',
                      color:
                        k === 'data' ? 'var(--data-color)' : k === 'rp' ? 'var(--rp-color)' : 'var(--credits-color)',
                    }}
                  >
              ...
              <div style={{ display: 'flex', gap: 4 }}>
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    fontFamily: 'var(--font-mono)',
                    cursor: p.affordable ? 'pointer' : 'not-allowed',
                    opacity: p.affordable ? 1 : 0.5,
                  }}
                >
                  {t('ui.buy')}
                </button>
      ...
      <AnimatePresence>
        {revealed.length > 0 && (
          ...
          >
            ...
            >
              <div
                style={{ fontSize: 14, fontWeight: 800, color: 'var(--text-primary)', fontFamily: 'var(--font-mono)' }}
              >
                {t('ui.chips_obtained')}
              </div>
                    ...
                    style={{
                      ...
                      boxShadow:
                        chip.rarity === 'legendary'
                          ? `0 0 16px ${RARITY_COLORS.legendary}40`
                          : chip.rarity === 'rare'
                            ? `0 0 8px ${RARITY_COLORS.rare}30`
                            : 'none',
                    }}
                  >
                    ...
                    >
                      {t('chip.' + chip.chipType + '.name') || chip.name}
                    </div>
                    <div
                      style={{
                        fontSize: 7,
                        color: RARITY_COLORS[chip.rarity],
                        fontFamily: 'var(--font-mono)',
