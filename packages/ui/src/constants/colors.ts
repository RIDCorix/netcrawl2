...
export const ITEM_LABELS: Record<string, string> = {
  ...
  rp_shard: 'RP Shard',
  bad_data: 'Bad Data',
  chip_pack_basic: 'Basic Pack',
  chip_pack_premium: 'Premium Pack',
  scanner: 'Scanner',
  signal_booster: 'Signal Booster',
  overclock_kit: 'Overclock Kit',
  antivirus_module: 'Antivirus Module',
  memory_allocator: 'Memory Allocator',
  fullstack_pickaxe: 'Fullstack Pickaxe',
  cpu_basic: 'CPU Module',
  cpu_advanced: 'CPU Module II',
  ram_basic: 'RAM Module',
  ram_advanced: 'RAM Module II',
};

export const ITEM_COLORS: Record<string, string> = {
  pickaxe_basic: '#9ca3af',
  pickaxe_iron: '#c0c0c0',
  ...
  rp_shard: '#a78bfa',
  bad_data: '#ef4444',
  chip_pack_basic: '#9ca3af',
  chip_pack_premium: '#f59e0b',
  cpu_basic: '#f59e0b',
  cpu_advanced: '#f97316',
  ram_basic: '#a78bfa',
  ram_advanced: '#8b5cf6',
