---
name: design-quest-chapter
description: Design a complete NetCrawl quest chapter with mainline + side quests, learning curve, rewards, and tutorial guides that fuse programming education with game feel.
---
